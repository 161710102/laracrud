	...
	<div class="container">
		<div class="col-md-12">
			<div class="panel panel-primary">
			  	<div class="panel-title pull-right"><a <a class="btn btn-outline-success" href="{{ route('beritas.index') }}">
			  ...
			  <div class="panel-body">
			  	<form action="{{ route('beritas.update',$beritas->id) }}" method="post" enctype="multipart/form-data">
					...
					<div class="form-group {{ $errors->has('gambar') ? ' has-error' : '' }}">
			  			...
			  			<input type="file" id="gambar" name="gambar" value="{{ $beritas->gambar }}" class="form-control"  required>
			  		...
			  		<div class="form-group {{ $errors->has('tgl_rilis') ? ' has-error' : '' }}">
			  			...
			  			<input type="date" name="tgl_rilis" value="{{ $beritas->tgl_rilis }}" class="form-control"  required>
					...
					<div class="form-group {{ $errors->has('judul') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="judul" value="{{ $beritas->judul }}" class="form-control"  required>
			  			@if ($errors->has('judul'))
                            <span class="help-block">
